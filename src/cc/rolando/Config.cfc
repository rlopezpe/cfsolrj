<!--- ****************************************************
This file was autogenerated by EnvironmentConfig on: {ts '2013-11-18 01:48:25'}
...
<cfcomponent displayname="Config" hint="Application properties bean" output="false">
	...
	<cfproperty name="solrLib" type="string" required="false" default=""  />
	...
	<cffunction name="init" returntype="Config" output="false" hint="I initialize the bean">
		...
		<cfargument name="solrLib" type="string" required="false" default=""  />
	...
	<cffunction name="getSolrServiceUrl" access="public" returntype="string" hint="I get solrServiceUrl variable" output="false">
		...
		<!--- setSolrLib(string) --->
	<cffunction name="setSolrLib" access="private" returntype="void" hint="I set solrLib variable" output="false">
		<cfargument name="value" type="string" required="true" />
		<cfset variables.inst.solrLib = arguments.value />
	</cffunction>

		<!--- getSolrLib() --->
	<cffunction name="getSolrLib" access="public" returntype="string" hint="I get solrLib variable" output="false">
		<cfreturn variables.inst.solrLib  />
	</cffunction>
